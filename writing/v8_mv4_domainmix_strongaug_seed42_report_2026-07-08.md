...
|---|---|---:|---:|---:|---:|---:|---|
| full | clean | 1 | 0.9545 | 0.0000 | 0.9545 | 0.9545 | 42 |
| full | light_noise_g002_p80_b002 | 1 | 0.9545 | 0.0000 | 0.9545 | 0.9545 | 42 |
| full | strong_noise_g005_p30_b005 | 1 | 0.9091 | 0.0000 | 0.9091 | 0.9091 | 42 |
| full | hard_nuisance_v2 | 1 | 0.7727 | 0.0000 | 0.7727 | 0.7727 | 42 |
| full | hard_nuisance_v3_mild | 1 | 1.0000 | 0.0000 | 1.0000 | 1.0000 | 42 |

## Interpretation

- `clean`: best mean accuracy is `0.9545` with `full`.
- `light_noise_g002_p80_b002`: best mean accuracy is `0.9545` with `full`.
- `strong_noise_g005_p30_b005`: best mean accuracy is `0.9091` with `full`.
- `hard_nuisance_v2`: best mean accuracy is `0.7727` with `full`.
- `hard_nuisance_v3_mild`: best mean accuracy is `1.0000` with `full`.
