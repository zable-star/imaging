...
|---|---|---:|---:|---:|---:|---:|---|
| full | clean | 3 | 0.9697 | 0.0525 | 0.9091 | 1.0000 | 42 332 2026 |
| full | light_noise_g002_p80_b002 | 3 | 0.7879 | 0.1389 | 0.6364 | 0.9091 | 42 332 2026 |
| full | strong_noise_g005_p30_b005 | 3 | 0.5606 | 0.0694 | 0.5000 | 0.6364 | 42 332 2026 |
| full | hard_nuisance_v2 | 3 | 0.5000 | 0.0000 | 0.5000 | 0.5000 | 42 332 2026 |
| full | hard_nuisance_v3_mild | 3 | 0.5000 | 0.0000 | 0.5000 | 0.5000 | 42 332 2026 |

## Interpretation

- `clean`: best mean accuracy is `0.9697` with `full`.
- `light_noise_g002_p80_b002`: best mean accuracy is `0.7879` with `full`.
- `strong_noise_g005_p30_b005`: best mean accuracy is `0.5606` with `full`.
- `hard_nuisance_v2`: best mean accuracy is `0.5000` with `full`.
