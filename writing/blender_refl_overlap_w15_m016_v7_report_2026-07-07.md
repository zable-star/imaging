...
This report records the v7 overlap-gate revision of the laser-gated military true/false-target dataset.
...
|---|---|---|---|---|---|---|
| Full 3-gate stack | 3 | 0.9091 | 0.0455 | 0.8636 | 0.9545 | 42/332/2026 |
| Gate 0 only | 3 | 0.7576 | 0.0262 | 0.7273 | 0.7727 | 42/332/2026 |
| Gate 1 only | 3 | 0.8939 | 0.0525 | 0.8636 | 0.9545 | 42/332/2026 |
| Gate 2 only | 3 | 0.9242 | 0.0946 | 0.8182 | 1.0000 | 42/332/2026 |

Per-run details:

| input | best val acc | best epoch | seed |
|---|---|---|---|
| Full 3-gate stack | 0.9091 | 10 | 2026 |
| Full 3-gate stack | 0.8636 | 13 | 332 |
| Full 3-gate stack | 0.9545 | 16 | 42 |
| Gate 0 only | 0.7727 | 9 | 2026 |
| Gate 0 only | 0.7273 | 8 | 332 |
| Gate 0 only | 0.7727 | 7 | 42 |
| Gate 1 only | 0.9545 | 12 | 2026 |
| Gate 1 only | 0.8636 | 8 | 332 |
| Gate 1 only | 0.8636 | 12 | 42 |
| Gate 2 only | 0.9545 | 12 | 2026 |
| Gate 2 only | 1.0000 | 14 | 332 |
| Gate 2 only | 0.8182 | 10 | 42 |

## v5 comparison

| input | v5 mean | current mean | delta |
|---|---|---|---|
| Full 3-gate stack | 0.9545 | 0.9091 | -0.0454 |
| Gate 0 only | 0.8788 | 0.7576 | -0.1212 |
| Gate 1 only | 0.9394 | 0.8939 | -0.0455 |
| Gate 2 only | 0.9545 | 0.9242 | -0.0303 |
